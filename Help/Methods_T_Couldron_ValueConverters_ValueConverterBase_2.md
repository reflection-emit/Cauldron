# ValueConverterBase(*TInput*, *TOutput*) Methods
 _**\[This is preliminary documentation and is subject to change.\]**_

The <a href="T_Couldron_ValueConverters_ValueConverterBase_2">ValueConverterBase(TInput, TOutput)</a> generic type exposes the following members.
...
<a href="#valueconverterbase(*tinput*,-*toutput*)-methods">Back to Top</a>
