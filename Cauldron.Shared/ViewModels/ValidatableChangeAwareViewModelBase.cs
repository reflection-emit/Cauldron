...
namespace Cauldron.ViewModels
{
    ...
    /// </summary>
    public abstract class ValidatableChangeAwareViewModelBase : ValidatableViewModelBase, IChangeAwareViewModel
    {
        private bool _isChanged;
        private bool _isLoading;

        /// <summary>
        /// Initializes a new instance of <see cref="ValidatableChangeAwareViewModelBase"/>
        /// </summary>
        /// <param name="id">A unique identifier of the viewmodel</param>
        public ValidatableChangeAwareViewModelBase(Guid id) : base(id)
        {
        }
        ...
        /// </summary>
        [Inject]
        public ValidatableChangeAwareViewModelBase() : base()
        {
        }
