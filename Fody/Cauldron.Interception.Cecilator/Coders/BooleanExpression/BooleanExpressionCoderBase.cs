    ...
    public abstract class BooleanExpressionCoderBase : CoderBase, IRelationalOperators
    {
        ...
        private void IsIsInternal(object value)
        {
            switch (value)
            {
                ...
                case BuilderType o: InstructionBlock.AreEqualInternalWithoutJump(this.instructions, BuilderTypes.Type, value); break;
                case TypeDefinition o: InstructionBlock.AreEqualInternalWithoutJump(this.instructions, BuilderTypes.Type, value); break;
                case TypeReference o: InstructionBlock.AreEqualInternalWithoutJump(this.instructions, BuilderTypes.Type, value); break;
                case Method o: InstructionBlock.AreEqualInternalWithoutJump(this.instructions, BuilderTypes.MethodBase, value); break;
