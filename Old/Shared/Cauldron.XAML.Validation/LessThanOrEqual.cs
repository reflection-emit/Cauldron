...
namespace Cauldron.XAML.Validation
{
    ...
    public sealed class LessThanOrEqualAttribute : ValidatorAttributeBase
    {
        private string propertyName;
        private object value;

        /// <summary>
        /// Initializes a new instance of <see cref="LessThanOrEqualAttribute"/>
        /// </summary>
        /// <param name="value">The value to compare to</param>
        /// <param name="errorMessageKey">The key of the localized error message string</param>
        public LessThanOrEqualAttribute(object value, string errorMessageKey) : base(errorMessageKey)
        {
            this.value = value;
        }
        ...
        public LessThanOrEqualAttribute(string propertyName, string errorMessageKey) : base(errorMessageKey)
        {
        ...
        protected override Task<bool> OnValidateAsync(PropertyInfo sender, IValidatableViewModel context, PropertyInfo propertyInfo, object value)
        {
            ...
            if (this.value != null)
                return Task.FromResult(!ComparerUtils.LessThanOrEqual(value, this.value));
            ...
            return Task.FromResult(!ComparerUtils.LessThanOrEqual(value, comparisonValue));
        }
