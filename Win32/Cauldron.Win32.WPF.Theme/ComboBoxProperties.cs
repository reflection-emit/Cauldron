...
{
    /// <summary>
    /// Provides attached properties for the <see cref="ComboBox"/>
    /// </summary>
    public static class ComboBoxProperties
    {
        ...
        /// </summary>
        public static readonly DependencyProperty ButtonsTemplateProperty = DependencyProperty.RegisterAttached("ButtonsTemplate", typeof(ControlTemplate), typeof(ComboBoxProperties), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty AlternativeTextProperty = DependencyProperty.RegisterAttached("AlternativeText", typeof(string), typeof(ComboBoxProperties), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty HeaderProperty = DependencyProperty.RegisterAttached("Header", typeof(string), typeof(ComboBoxProperties), new PropertyMetadata(null));
