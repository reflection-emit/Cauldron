...
{
    /// <summary>
    /// Provides attached properties for the <see cref="ContentControl"/> control
    /// </summary>
    public static class ContentControlProperties
    {
        ...
        /// </summary>
        public static readonly DependencyProperty HeaderProperty = DependencyProperty.RegisterAttached("Header", typeof(string), typeof(ContentControlProperties), new PropertyMetadata(null));
