...
namespace Cauldron.XAML.Validation
{
    ...
    public sealed class GreaterThanAttribute : ValidatorAttributeBase
    {
        ...
        protected override Task<bool> OnValidateAsync(PropertyInfo sender, IValidatableViewModel context, PropertyInfo propertyInfo, object value)
        {
            ...
            if (this.value != null)
                return Task.FromResult(!Comparer.GreaterThan(value, this.value));
            ...
            return Task.FromResult(!Comparer.GreaterThan(value, comparisonValue));
        }
