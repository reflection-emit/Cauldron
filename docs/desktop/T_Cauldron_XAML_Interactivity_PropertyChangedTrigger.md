...
Provides a <a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Behaviour(T)</a> that can invoke <a href="T_Cauldron_XAML_Interactivity_Actions_ActionBase">ActionBase</a> behaviours if a property changes


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.Windows.Threading.DispatcherObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.DependencyObject<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Media.Visual<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.UIElement<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.FrameworkElement<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Cauldron.XAML.Interactivity.Behaviour</a>(FrameworkElement)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cauldron.XAML.Interactivity.PropertyChangedTrigger<br />
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger__ctor">PropertyChangedTrigger</a></td><td>
Initializes a new instance of the PropertyChangedTrigger class</td></tr></table>&nbsp;
<a href="#propertychangedtrigger-class">Back to Top</a>

## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_PropertyChangedTrigger_Actions">Actions</a></td><td>
...
Gets a value that uniquely identifies this element.
 (Inherited from UIElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_PropertyChangedTrigger_Property">Property</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_PropertyChangedTrigger_Property">Property</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>RenderSize</td><td>
...
When overridden in a derived class, is invoked whenever application code or internal processes call ApplyTemplate().
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger_OnAttach">OnAttach</a></td><td>
...
Invoked whenever an unhandled ContextMenuOpening routed event reaches this class in its route. Implement this method to add class handling for this event.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger_OnCopy">OnCopy</a></td><td>
...
Returns class-specific AutomationPeer implementations for the Windows Presentation Foundation (WPF) infrastructure.
 (Inherited from UIElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger_OnDataContextChanged">OnDataContextChanged</a></td><td>
Occures if the DataContext of <a href="P_Cauldron_XAML_Interactivity_Behaviour_1_AssociatedObject">AssociatedObject</a> has changed
 (Overrides <a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnDataContextChanged">Behaviour(T).OnDataContextChanged()</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger_OnDataContextPropertyChanged">OnDataContextPropertyChanged</a></td><td>
Occures if the DataContext has invoked the [!:INotifyPropertyChanged.PropertyChanged] event
 (Overrides <a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnDataContextPropertyChanged">Behaviour(T).OnDataContextPropertyChanged(String)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_PropertyChangedTrigger_OnDetach">OnDetach</a></td><td>
