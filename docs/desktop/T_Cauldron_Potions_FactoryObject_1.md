# FactoryObject(*TInterface*) Class
...
System.Object<br />&nbsp;&nbsp;Cauldron.Potions.FactoryObject(TInterface)<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_Potions_Network">Cauldron.Potions.Network</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_Potions_Serializer">Cauldron.Potions.Serializer</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_Potions_UserInformation">Cauldron.Potions.UserInformation</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_Potions_Web">Cauldron.Potions.Web</a><br />
...
#### Type Parameters
&nbsp;<dl><dt>TInterface</dt><dd>The interface used</dd></dl>&nbsp;
The FactoryObject(TInterface) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_Potions_FactoryObject_1__ctor">FactoryObject(TInterface)</a></td><td>
Initializes a new instance of the FactoryObject(TInterface) class</td></tr></table>&nbsp;
<a href="#factoryobject(*tinterface*)-class">Back to Top</a>

## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_Cauldron_Potions_FactoryObject_1_CreateInstance">CreateInstance</a></td><td>
