# ImageProperties.AnimateOpacity Attached Property
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:Cauldron.XAML.Interactivity.Attached.ImageProperties.AnimateOpacity"\]
...
**C#**<br />
``` C#
See GetAnimateOpacity, SetAnimateOpacity
```
