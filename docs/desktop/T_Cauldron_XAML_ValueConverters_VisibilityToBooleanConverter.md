# VisibilityToBooleanConverter Class
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "T:Cauldron.XAML.ValueConverters.VisibilityToBooleanConverter"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_Cauldron_XAML_ValueConverterBase">Cauldron.XAML.ValueConverterBase</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Cauldron.XAML.ValueConverters.VisibilityToBooleanConverter<br />
...
The VisibilityToBooleanConverter type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverters_VisibilityToBooleanConverter__ctor">VisibilityToBooleanConverter</a></td><td>
Initializes a new instance of the VisibilityToBooleanConverter class</td></tr></table>&nbsp;
<a href="#visibilitytobooleanconverter-class">Back to Top</a>

## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverterBase_Convert">Convert</a></td><td> (Inherited from <a href="T_Cauldron_XAML_ValueConverterBase">ValueConverterBase</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverterBase_ConvertBack">ConvertBack</a></td><td> (Inherited from <a href="T_Cauldron_XAML_ValueConverterBase">ValueConverterBase</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>Equals</td><td>
...
Creates a shallow copy of the current Object.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverters_VisibilityToBooleanConverter_OnConvert">OnConvert</a></td><td> (Overrides <a href="M_Cauldron_XAML_ValueConverterBase_OnConvert">ValueConverterBase.OnConvert(Object, Type, Object, String)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverters_VisibilityToBooleanConverter_OnConvertBack">OnConvertBack</a></td><td> (Overrides <a href="M_Cauldron_XAML_ValueConverterBase_OnConvertBack">ValueConverterBase.OnConvertBack(Object, Type, Object, String)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>ToString</td><td>
...
#### Reference
<a href="N_Cauldron_XAML_ValueConverters">Cauldron.XAML.ValueConverters Namespace</a><br />