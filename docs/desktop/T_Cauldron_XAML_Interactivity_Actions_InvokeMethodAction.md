...
The InvokeMethodAction type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction__ctor">InvokeMethodAction</a></td><td>
Initializes a new instance of the InvokeMethodAction class</td></tr></table>&nbsp;
<a href="#invokemethodaction-class">Back to Top</a>
...
Gets or sets the maximum width constraint of the element.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodName">MethodName</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodName">MethodName</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodOwnerType">MethodOwnerType</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodOwnerType">MethodOwnerType</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodParameters">MethodParameters</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_MethodParameters">MethodParameters</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>MinHeight</td><td>
...
Gets or sets a value that indicates whether this element incorporates style properties from theme styles.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_ParametersFromTemplatedParent">ParametersFromTemplatedParent</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_ParametersFromTemplatedParent">ParametersFromTemplatedParent</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Parent</td><td>
...
Gets a value that uniquely identifies this element.
 (Inherited from UIElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_PriorityLow">PriorityLow</a></td><td>
Gets or sets the <a href="P_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_PriorityLow">PriorityLow</a> Property</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>RenderSize</td><td>
...
Invalidates the rendering of the element, and forces a complete new layout pass. OnRender(DrawingContext) is called after the layout cycle is completed.
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_Invoke">Invoke</a></td><td>
Occures when the action is invoked by an event
 (Overrides <a href="M_Cauldron_XAML_Interactivity_Actions_ActionBase_Invoke">ActionBase.Invoke(Object)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>IsAncestorOf</td><td>
...
When overridden in a derived class, is invoked whenever application code or internal processes call ApplyTemplate().
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_OnAttach">OnAttach</a></td><td>
...
Occures if the DataContext has invoked the [!:INotifyPropertyChanged.PropertyChanged] event
 (Inherited from <a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Behaviour(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_Actions_InvokeMethodAction_OnDetach">OnDetach</a></td><td>
