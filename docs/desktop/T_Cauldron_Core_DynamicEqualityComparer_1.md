...
System.Object<br />&nbsp;&nbsp;Cauldron.Core.DynamicEqualityComparer(T)<br />
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>The type of objects to compare</dd></dl>&nbsp;
The DynamicEqualityComparer(T) type exposes the following members.
...
Initializes a new instance of DynamicEqualityComparer(T)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_Core_DynamicEqualityComparer_1__ctor_1">DynamicEqualityComparer(T)(Func(T, T, Boolean), Func(T, Int32))</a></td><td>
Initializes a new instance of DynamicEqualityComparer(T)</td></tr></table>&nbsp;
<a href="#dynamicequalitycomparer(*t*)-class">Back to Top</a>
...
Determines whether the specified object are equal</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>Finalize</td><td>
...
Returns a hash code for the specified object</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>GetType</td><td>
