# BehaviourInvokeAwareBehaviourBase(*T*) Class
...
**C#**<br />
``` C#
public abstract class BehaviourInvokeAwareBehaviourBase<T> : Behaviour<T>
...
The BehaviourInvokeAwareBehaviourBase(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_BehaviourInvocation_BehaviourInvokeAwareBehaviourBase_1__ctor">BehaviourInvokeAwareBehaviourBase(T)</a></td><td>
Initializes a new instance of the BehaviourInvokeAwareBehaviourBase(T) class</td></tr></table>&nbsp;
<a href="#behaviourinvokeawarebehaviourbase(*t*)-class">Back to Top</a>
...
Gets or sets the method name</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>MinHeight</td><td>
...
Invalidates the rendering of the element, and forces a complete new layout pass. OnRender(DrawingContext) is called after the layout cycle is completed.
 (Inherited from UIElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_BehaviourInvocation_BehaviourInvokeAwareBehaviourBase_1_Invoke">Invoke</a></td><td>
Occures if the behaviour is requested to invoke</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>IsAncestorOf</td><td>
...
Occures when the behavior is attached to the object
 (Inherited from <a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Behaviour(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnChildDesiredSizeChanged</td><td>
...
Occures if the DataContext has invoked the [!:INotifyPropertyChanged.PropertyChanged] event
 (Inherited from <a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Behaviour(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_BehaviourInvocation_BehaviourInvokeAwareBehaviourBase_1_OnDetach">OnDetach</a></td><td>
