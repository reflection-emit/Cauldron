# BooleanToVisibilityConverter Methods
 _**\[This is preliminary documentation and is subject to change.\]**_

The <a href="T_Cauldron_XAML_ValueConverters_BooleanToVisibilityConverter">BooleanToVisibilityConverter</a> type exposes the following members.
...
Creates a shallow copy of the current Object.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverters_BooleanToVisibilityConverter_OnConvert">OnConvert</a></td><td> (Overrides <a href="M_Cauldron_XAML_ValueConverterBase_OnConvert">ValueConverterBase.OnConvert(Object, Type, Object, String)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_ValueConverters_BooleanToVisibilityConverter_OnConvertBack">OnConvertBack</a></td><td> (Overrides <a href="M_Cauldron_XAML_ValueConverterBase_OnConvertBack">ValueConverterBase.OnConvertBack(Object, Type, Object, String)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>ToString</td><td>
