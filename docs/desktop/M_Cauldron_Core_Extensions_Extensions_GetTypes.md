...
#### Parameters
&nbsp;<dl><dt>objs</dt><dd>Type: System.Object[]<br />The object array to get the type from</dd></dl>

#### Return Value
Type: Type[]<br />An array of types that represents the object array
