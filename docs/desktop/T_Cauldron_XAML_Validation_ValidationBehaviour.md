...
**C#**<br />
``` C#
public sealed class ValidationBehaviour : Behaviour<FrameworkElement>, 
	ICloneable
```

The ValidationBehaviour type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBehaviour__ctor">ValidationBehaviour</a></td><td>
Initializes a new instance of the ValidationBehaviour class</td></tr></table>&nbsp;
<a href="#validationbehaviour-class">Back to Top</a>
...
Clears the local value of a read-only property. The property to be cleared is specified by a DependencyPropertyKey.
 (Inherited from DependencyObject.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBehaviour_Clone">Clone</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>CoerceValue</td><td>
...
When overridden in a derived class, is invoked whenever application code or internal processes call ApplyTemplate().
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBehaviour_OnAttach">OnAttach</a></td><td> (Overrides <a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnAttach">Behaviour(T).OnAttach()</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnChildDesiredSizeChanged</td><td>
...
Returns class-specific AutomationPeer implementations for the Windows Presentation Foundation (WPF) infrastructure.
 (Inherited from UIElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBehaviour_OnDataContextChanged">OnDataContextChanged</a></td><td> (Overrides <a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnDataContextChanged">Behaviour(T).OnDataContextChanged()</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnDataContextPropertyChanged">OnDataContextPropertyChanged</a></td><td>
Occures if the DataContext has invoked the [!:INotifyPropertyChanged.PropertyChanged] event
 (Inherited from <a href="T_Cauldron_XAML_Interactivity_Behaviour_1">Behaviour(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBehaviour_OnDetach">OnDetach</a></td><td> (Overrides <a href="M_Cauldron_XAML_Interactivity_Behaviour_1_OnDetach">Behaviour(T).OnDetach()</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnDragEnter</td><td>
