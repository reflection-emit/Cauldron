...
\[Missing <summary> documentation for "T:Cauldron.XAML.Resources.LocalizationSource"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;Cauldron.XAML.Resources.LocalizationSource<br />
...
**C#**<br />
``` C#
[ComponentAttribute(typeof(ILocalizationSource), FactoryCreationPolicy.Singleton)]
public sealed class LocalizationSource : ILocalizationSource
```

The LocalizationSource type exposes the following members.


## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Resources_LocalizationSource_Contains">Contains</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>Equals</td><td>
...
Gets the Type of the current instance.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Resources_LocalizationSource_GetValue">GetValue</a></td><td /></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>MemberwiseClone</td><td>
Creates a shallow copy of the current Object.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>ToString</td><td>
Returns a string that represents the current object.
 (Inherited from Object.)</td></tr></table>&nbsp;
<a href="#localizationsource-class">Back to Top</a>
