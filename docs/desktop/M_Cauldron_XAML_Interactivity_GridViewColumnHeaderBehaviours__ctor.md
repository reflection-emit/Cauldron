# GridViewColumnHeaderBehaviours Constructor 
 _**\[This is preliminary documentation and is subject to change.\]**_

Initializes a new instance of the <a href="T_Cauldron_XAML_Interactivity_GridViewColumnHeaderBehaviours">GridViewColumnHeaderBehaviours</a> class
...
**C#**<br />
``` C#
public GridViewColumnHeaderBehaviours()
```
