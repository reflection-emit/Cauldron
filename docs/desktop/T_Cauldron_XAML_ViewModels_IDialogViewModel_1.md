# IDialogViewModel(*TResult*) Interface
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "T:Cauldron.XAML.ViewModels.IDialogViewModel`1"\]
...
#### Type Parameters
&nbsp;<dl><dt>TResult</dt><dd>\[Missing <typeparam name="TResult"/> documentation for "T:Cauldron.XAML.ViewModels.IDialogViewModel`1"\]</dd></dl>&nbsp;
The IDialogViewModel(TResult) type exposes the following members.
...
<a href="#idialogviewmodel(*tresult*)-interface">Back to Top</a>
