...
\[Missing <summary> documentation for "T:Cauldron.XAML.Validation.PasswordStrengthAttribute"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.Attribute<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Cauldron_XAML_Validation_ValidationBaseAttribute">Cauldron.XAML.Validation.ValidationBaseAttribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cauldron.XAML.Validation.PasswordStrengthAttribute<br />
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_Validation_PasswordStrengthAttribute__ctor">PasswordStrengthAttribute</a></td><td>
Initializes a new instance of the PasswordStrengthAttribute class</td></tr></table>&nbsp;
...
Creates a shallow copy of the current Object.
 (Inherited from Object.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Validation_PasswordStrengthAttribute_OnValidate">OnValidate</a></td><td> (Overrides <a href="M_Cauldron_XAML_Validation_ValidationBaseAttribute_OnValidate">ValidationBaseAttribute.OnValidate(PropertyInfo, IValidatableViewModel, PropertyInfo, Object)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>ToString</td><td>
Returns a string that represents the current object.
 (Inherited from Object.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Cauldron_XAML_Validation_ValidationBaseAttribute_ValidationMessage">ValidationMessage</a></td><td> (Inherited from <a href="T_Cauldron_XAML_Validation_ValidationBaseAttribute">ValidationBaseAttribute</a>.)</td></tr></table>&nbsp;
<a href="#passwordstrengthattribute-class">Back to Top</a>
