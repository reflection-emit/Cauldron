# CauldronUICommand Class
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "T:Cauldron.XAML.CauldronUICommand"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;Cauldron.XAML.CauldronUICommand<br />
...
The CauldronUICommand type exposes the following members.
...
Initializes a new instance of the CauldronUICommand class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_CauldronUICommand__ctor_1">CauldronUICommand(String, Action)</a></td><td>
Initializes a new instance of the CauldronUICommand class</td></tr></table>&nbsp;
<a href="#cauldronuicommand-class">Back to Top</a>
...
Gets the Type of the current instance.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_XAML_CauldronUICommand_Invoke">Invoke</a></td><td /></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>MemberwiseClone</td><td>
