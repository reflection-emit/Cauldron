# BehaviourInvokeAwareBehaviourBase(*T*) Methods
 _**\[This is preliminary documentation and is subject to change.\]**_

The <a href="T_Cauldron_XAML_Interactivity_BehaviourInvocation_BehaviourInvokeAwareBehaviourBase_1">BehaviourInvokeAwareBehaviourBase(T)</a> generic type exposes the following members.
