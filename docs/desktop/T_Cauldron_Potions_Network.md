...
System.Object<br />&nbsp;&nbsp;<a href="T_Cauldron_Potions_FactoryObject_1">Cauldron.Potions.FactoryObject</a>(<a href="T_Cauldron_Potions_INetwork">INetwork</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;Cauldron.Potions.Network<br />
...
**C#**<br />
``` C#
[ComponentAttribute(typeof(INetwork), FactoryCreationPolicy.Instanced)]
public sealed class Network : FactoryObject<INetwork>, 
	INetwork
```
...
<a href="#network-class">Back to Top</a>
...
Creates a shallow copy of the current Object.
 (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Cauldron_Potions_Network_Ping">Ping</a></td><td>
Allows an application to determine whether a remote computer is accessible over the network.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>ToString</td><td>
