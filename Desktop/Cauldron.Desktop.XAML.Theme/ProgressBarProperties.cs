...
namespace Cauldron.XAML.Theme
{
    public static class ProgressBarProperties
    {
        ...
        internal static double GetDiameter(DependencyObject obj)
        {
            return (double)obj.GetValue(DiameterProperty);
        }
        ...
        internal static void SetDiameter(DependencyObject obj, double value)
        {
            obj.SetValue(DiameterProperty, value);
        }
