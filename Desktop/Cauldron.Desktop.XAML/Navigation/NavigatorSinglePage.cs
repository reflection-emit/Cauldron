...
namespace Cauldron.XAML.Navigation
{
    ...
    public sealed class NavigatorSinglePage : Singleton<INavigator>, INavigator
    {
        ...
        /// <summary>
        /// Create a new <see cref="ContentDialog"/> or <see cref="Flyout"/> with the view defined by the view model, depending on the views definition, also passing a parameter to be used to construct the view model.
        /// </summary>
        /// <typeparam name="T">The type of the viewmodel to construct</typeparam>
        /// <typeparam name="TResult">The result type of the dialog</typeparam>
        /// <param name="callback">A delegate that is called after the popup has been closed</param>
