...
namespace Cauldron
{
    ...
    public partial class MessageDialog
    {
        ...
        public async Task ShowAsync(string title, string content, uint defaultCommandIndex, uint cancelCommandIndex, MessageDialogCommandList commands)
        {
        ...
        /// <param name="commands">An array of commands that appear in the command bar of the message dialog. These commands makes the dialog actionable.</param>
        /// <returns>An object that represents the asynchronous operation.</returns>
        public async Task ShowAsync(string title, string content, uint defaultCommandIndex, uint cancelCommandIndex, MessageBoxImage messageBoxImage, MessageDialogCommandList commands)
        {
            ...
            var navigator = Factory.Create<INavigator>();
        ...
        /// <returns>An object that represents the asynchronous operation.</returns>
        public async Task ShowAsync(string title, string content, MessageBoxImage messageBoxImage, MessageDialogCommand command1, MessageDialogCommand command2)
        {
        ...
        /// <returns>An object that represents the asynchronous operation.</returns>
        public async Task ShowOKAsync(string title, Exception e)
        {
