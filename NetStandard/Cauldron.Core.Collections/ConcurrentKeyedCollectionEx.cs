...
{
    /// <summary>
    /// Provides an implementation of the <see cref="ConcurrentKeyedCollectionEx{TKey, TItem}"/> that can define the key on construction
    /// </summary>
    ...
    public sealed class ConcurrentKeyedCollectionEx<TKey, TItem> : ConcurrentKeyedCollection<TKey, TItem>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConcurrentKeyedCollectionEx{TKey, TItem}"/> class that uses the default equality comparer.
        /// </summary>
        /// <param name="keySelector">A function to extract a key from each element.</param>
        public ConcurrentKeyedCollectionEx(Func<TItem, TKey> keySelector)
        {
            this.keySelector = keySelector;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ConcurrentKeyedCollectionEx{TKey, TItem}"/>
        ...
        /// </param>
        public ConcurrentKeyedCollectionEx(Func<TItem, TKey> keySelector, IEqualityComparer<TKey> comparer) : base(comparer)
        {
            this.keySelector = keySelector;
        }
        ...
        public ConcurrentKeyedCollectionEx(Func<TItem, TKey> keySelector, IEqualityComparer<TKey> comparer, int dictionaryCreationThreshold) : base(comparer, dictionaryCreationThreshold)
        {
            this.keySelector = keySelector;
        }
