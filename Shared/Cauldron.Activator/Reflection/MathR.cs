...
namespace System  /* Make this prominent ... side by side with Math */
{
    ...
    /// </summary>
    public static partial class MathR
    {
        /// <summary>
        /// Adds <paramref name="a"/> to <paramref name="b"/>
        /// <para/>
        /// If <paramref name="a"/> and <paramref name="b"/> are null then null is returned. If
        /// <paramref name="a"/> is null then <paramref name="b"/> is returned. If <paramref
        /// name="b"/> is null then <paramref name="a"/> is returned.
        /// <para/>
        /// Tries to cast primitiv <see cref="Type"/> and use the + operator. If the <see
        /// cref="Type"/> is unknown then reflection is used to determin the operator.
        /// </summary>
        ...
        /// <para/>
        /// If <paramref name="a"/> and <paramref name="b"/> are null then null is returned. If
        /// <paramref name="a"/> is null then 0 is returned. If <paramref name="b"/> is null then
