...
namespace System.Collections.Generic
{
        ...
        where TValue : class
    {
        ...
        /// <summary>
        /// Copies the elements of the <see cref="FastDictionary{TKey, TValue}"/> to an System.Array, starting at a particular System.Array index.
        /// </summary>
        /// <param name="array">
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            var result = new FastDictionaryEnumerator(this.entries).GetItems().ToArray();
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() => new FastDictionaryEnumerator(this.entries);

        /// <summary>
        /// Returns an enumerator that iterates through the collection.
        /// </summary>
        /// <returns>An enumerator that can be used to iterate through the collection.</returns>
        IEnumerator IEnumerable.GetEnumerator() => new FastDictionaryEnumerator(this.entries);

        /// <summary>
        /// Returns an enumerator that iterates through the collection.
        /// </summary>
        /// <returns>An enumerator that can be used to iterate through the collection.</returns>
        IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() => new FastDictionaryEnumerator(this.entries);
        ...
        private void Add(TKey key, TValue value, bool overwrite)
        {
            ...
            entries[storePos] = new FastDictionaryEntry
            {
                next = entryLocation,
                key = key,
                value = value,
        ...
        private class FastDictionaryEntry
        {
        ...
        private sealed class FastDictionaryEnumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IEnumerator<TValue>
        {
            private int currentIndex = -1;
            private FastDictionaryEntry[] entries;

            internal FastDictionaryEnumerator(FastDictionaryEntry[] entries) =>
