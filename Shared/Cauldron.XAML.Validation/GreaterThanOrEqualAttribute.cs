...
namespace Cauldron.XAML.Validation
{
    ...
    public sealed class GreaterThanOrEqualAttribute : ValidatorAttributeBase
    {
        ...
        protected override Task<bool> OnValidateAsync(PropertyInfo sender, IValidatableViewModel context, PropertyInfo propertyInfo, object value)
        {
            ...
            if (this.value != null)
                return Task.FromResult(!ComparerUtils.GreaterThanOrEqual(value, this.value));
            ...
            return Task.FromResult(!ComparerUtils.GreaterThanOrEqual(value, comparisonValue));
        }
