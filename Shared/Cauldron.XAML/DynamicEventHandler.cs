...
namespace Cauldron.XAML
{
    ...
    public sealed class DynamicEventHandler : DisposableBase
    {
        ...
        private void AttachEvent()
        {
            ...
            {
                Output.WriteLineError("The DynamicEventHandler was not able to add a handler to the event: '" + this.EventName + "'");
                Output.WriteLineError("Exception was raised: " + e.Message);
                return;
            }
